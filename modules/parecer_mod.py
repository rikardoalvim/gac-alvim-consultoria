...
def run():
    ...
    if df_cand.empty:
        ...
        if id_candidato_escolhido != "(Nenhum)" and st.button("Carregar dados do candidato"):
            row = df_cand[df_cand["id_candidato"] == str(id_candidato_escolhido)].iloc[0]
            ...
            st.session_state["id_candidato_selecionado"] = str(row["id_candidato"])
